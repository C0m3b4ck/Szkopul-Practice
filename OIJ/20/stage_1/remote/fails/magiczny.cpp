...
int main()
{
	...
	if (magical_square[5] == '?') {magical_square[5] = magical_square[1];}
	if (magical_square[10] == '?') {magical_square[10] = magical_square[2];}
	if (magical_square[15] == '?') {magical_square[15] = magical_square[3];}
	if (magical_square[20] == '?') {magical_square[20] = magical_square[4];}
	// row 0 (square 0 excluded)
	if (magical_square[1] == '?') {magical_square[1] = magical_square[5];}
	if (magical_square[2] == '?') {magical_square[2] = magical_square[10];}
	if (magical_square[3] == '?') {magical_square[3] = magical_square[15];}
	if (magical_square[4] == '?') {magical_square[4] = magical_square[20];}
	//column 1 (squares 1 and 6 excluded)
	if (magical_square[11] == '?') {magical_square[11] = magical_square[7];}
	if (magical_square[16] == '?') {magical_square[16] = magical_square[8];}
	if (magical_square[21] == '?') {magical_square[21] = magical_square[9];}
	//row 1 (square 5 excluded)
	if (magical_square[7] == '?') {magical_square[7] = magical_square[11];}
	if (magical_square[8] == '?') {magical_square[8] = magical_square[16];}
	if (magical_square[9] == '?') {magical_square[9] = magical_square[21];}	
	//column 2 (squares 2, 7 and 12 excluded)
	//17, 22
	if (magical_square[17] == '?') {magical_square[17] = magical_square[13];}
	if (magical_square[22] == '?') {magical_square[22] = magical_square[14];}
	//row 2
	if (magical_square[13] == '?') {magical_square[13] = magical_square[17];}
	if (magical_square[14] == '?') {magical_square[14] = magical_square[22];}
	//column 3 (squares 3, 8, 13 and 18 excluded)
	//23
	if (magical_square[23] == '?') {magical_square[23] = magical_square[19];}
	//row 3
	if (magical_square[19] == '?') {magical_square[19] = magical_square[23];}
